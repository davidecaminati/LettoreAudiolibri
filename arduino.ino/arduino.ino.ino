...
void setup() {
  ...
  digitalWrite(DigitalInPin2, HIGH);       // turn on pullup resistors
  pinMode(DigitalInPin3, INPUT);
  digitalWrite(DigitalInPin3, HIGH);       // turn on pullup resistors
  pinMode(DigitalInPin4, INPUT);
  digitalWrite(DigitalInPin4, HIGH);       // turn on pullup resistors
}
